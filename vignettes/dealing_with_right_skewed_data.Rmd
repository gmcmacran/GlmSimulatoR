...
This critical step is being able to spot a gamma distribution when you see one. Theatrical skewness is $\frac{2}{scale}$. Note the gamma distribution is always positive.
...
Above we saw the gamma take on many different shapes. The inverse gaussian distribution is not as flexible. It tends to maintain it's skewness for a variety of parameters.
...
# Building A Models With Very Skewed Data Using Inverse Gaussian Distribution
